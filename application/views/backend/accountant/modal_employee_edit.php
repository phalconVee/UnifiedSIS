...
foreach ($edit_data as $row):
    ...
    <?php echo form_open(base_url() . 'index.php?accountant/employee/do_update/'.$row['emp_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
...
<script type="text/javascript">
    ...
    function get_lga(state_id) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>index.php?accountant/get_lga/' + state_id ,
