...
<?php echo form_open(base_url() . 'index.php?accountant/employee_import/import_excel/' , array('class' => 'form-horizontal form-groups-bordered validate', 'style' => 'text-align:center;', 'enctype' => 'multipart/form-data', 'autcomplete' => 'off'));?>
...
<script type="text/javascript">
    ...
    $("#generate_csv").click(function() {
        ...
        $.ajax({
            url: '<?=base_url();?>index.php?accountant/download/bulk_employee.csv',
