	...
	<div class="col-md-12">
		...
		<div class="tabs-vertical-env">
			...
			<li class="active"><a href="#b-profile" data-toggle="tab">Select A SMS Service</a></li>
                ...
                <li>
                    <a href="#v-ebulk-sms-profile" data-toggle="tab">
                        Ebulk SMS Settings
                        <?php if ($active_sms_service == 'ebulksms'):?>
                            <span class="badge badge-success"><?php echo get_phrase('active');?></span>
                        <?php endif;?>
                    </a>
                </li>
                ...
                <li>
                    <a href="#v-bulksmsnigeria-profile" data-toggle="tab">
                        BulkSMS Nigeria Settings
                        <?php if ($active_sms_service == 'bulksmsnigeria'):?>
                            <span class="badge badge-success"><?php echo get_phrase('active');?></span>
                        <?php endif;?>
                    </a>
                </li>
			...
			<div class="tab-content">
                        ...
                        <div class="col-sm-5">
							...
							<select name="active_sms_service" class="form-control selectboxit">
							  ...
							  <option value="msg91"
                                ...
                                <option value="ebulksms"
                                    <?php if ($active_sms_service == 'ebulksms') echo 'selected';?>>
                                    Ebulk SMS
                                </option>

                                  <option value="bulksmsnigeria"
                                    <?php if ($active_sms_service == 'bulksmsnigeria') echo 'selected';?>>
                                    BulkSMS Nigeria
                                </option>
                ...
                <!-- E-bulk SMS settings -->
                <div class="tab-pane" id="v-ebulk-sms-profile">

                    <?php echo form_open(base_url() . 'index.php?admin/sms_settings/ebulksms' ,
                        array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="username"
                                   value="<?php echo $this->db->get_where('settings' , array('type' =>'ebulk_sms_user'))->row()->description;?>" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <label  class="col-sm-3 control-label"><?php echo get_phrase('api_key');?></label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="api_key"
                                   value="<?php echo $this->db->get_where('settings' , array('type' =>'ebulk_sms_apikey'))->row()->description;?>" required>
                        </div>
                ...
                <!-- Bulk SMS Nigeria settings -->
                <div class="tab-pane" id="v-bulksmsnigeria-profile">

                    <?php echo form_open(base_url() . 'index.php?admin/sms_settings/bulksmsnigeria' ,
                        array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="username"
                                   value="<?php echo $this->db->get_where('settings' , array('type' =>'bulksmsnigeria_user'))->row()->description;?>" required>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="password"
                                   value="<?php echo $this->db->get_where('settings' , array('type' =>'bulksmsnigeria_pass'))->row()->description;?>" required>
                        </div>
