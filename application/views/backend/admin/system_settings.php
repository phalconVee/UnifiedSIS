        ...
        <div class="col-md-6">
            ...
            <div class="panel panel-primary" >
                ...
                <div class="panel-body">
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('sms_sender_title');?></label>
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="sms_sender_title"
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'sms_sender_title'))->row()->description;?>" required>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('paystack_public_key');?></label>
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="paystack_public_key"
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'paystack_public_key'))->row()->description;?>">
                      </div>
                  </div>

                  <div class="form-group">
                      <label  class="col-sm-3 control-label"><?php echo get_phrase('paystack_secret_key');?></label>
                      <div class="col-sm-9">
                          <input type="text" class="form-control" name="paystack_secret_key"
                              value="<?php echo $this->db->get_where('settings' , array('type' =>'paystack_secret_key'))->row()->description;?>">
                      </div>
                  </div>
