...
<div class="container">
    ...
    <div id="myModal" class="modal">
        <div class="modal-dialog">
          ...
          <!-- Modal content -->
          <div id="modal-content" class="modal-content" style="margin-top:100px;">
        ...
        <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <select name="class_id" id="class_id" onchange="get_students(this.value)" class="form-control" style="width: 250px;">
        ...
        <div id="html-content-holder" class="area" style="background-color: #fff;">
            <div class="side">
                <center>
                    ...
                    <!-- <div class="photo"> -->
                        <img class="photo" id="photo" src="uploads/photo-here.png" width="114" height="122">
                    <!-- </div> -->
                    <div class="name">
                        <p id="student_name">Bigbros Labs</p>
                    </div>
                </center>
                <div style="height: 10px;"></div>

                <div class="detail-content" style="font-size: 12px;width: 320px;height: 26px;">
                    <div style="float: left;padding-right: 7px;"><label>Admission. No. :</label></div>
                    <div style="float: left;padding-right: 7px;" id="student_rollno"><p>08/2015-17</p></div>                    
                </div>
                ...
                <div class="detail-content" style="width: 320px;height: 26px;font-size: 12px;">
                    ...
                    <div style="float: left;padding-right: 7px;" id="student_dob"><p>20/09/1987</p></div>
                    <div style="float: left;padding-right: 7px;"><label>Gender :</label></div>
                    <div style="float: left;padding-right: 7px;" id="student_gender"><p>Male</p></div>
                </div>

                <div class="detail-content" style="width: 320px;height: 26px;font-size: 12px;">
                    <div style="float: left;padding-right: 7px;"><label>Address :</label></div>
                    <div style="float: left;padding-right: 7px;" id="student_address"><p> 2014 Illinois Avenue | 503-762-2429</p></div>
                </div>

                <div class="detail-content" style="width: 320px;height: 26px;font-size: 12px;">
                    <div style="float: left;padding-right: 7px;"><label>Document No. : </label></div>
                    <div style="float: left;padding-right: 7px;" id="student_code"><p>+91 90325 81559</p></div>
...
<script type="text/javascript">
    function get_students(class_id) {
        if(class_id !== ''){
        $.ajax({
            url: '<?php echo base_url();?>index.php?admin/get_classes_id_card/' + class_id ,
