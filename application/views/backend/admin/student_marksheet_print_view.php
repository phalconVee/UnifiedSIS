...
<div id="print">
    ...
    <thead>
        ...
        <tr>
            <td style="text-align: center;"><strong>TOTAL SCORE</strong></td>
            <td style="text-align: center;" colspan="8">

                <?php
                $total_score_query = $this->db->get_where('result', array(
                    'exam_id' => $exam_id,
                ...
                if($total_score_query->num_rows() > 0) {
                    $total_mark = $total_score_query->row()->total_mark;
                    echo $total_mark;
                }
                ?>
            </td>
