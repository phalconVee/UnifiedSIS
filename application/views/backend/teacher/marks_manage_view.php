	...
	<div class="col-md-12">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <th><?php echo get_phrase('other_marks');?> <span class="badge badge-info" data-toggle="popover" data-trigger="hover" data-placement="top" data-content="These are marks aside from first test and second test, that you may award to students e.g. assignment etc."><i class="fa fa-info"></i></span></th>
                <th><?php echo get_phrase('first_test');?></th>
                <th><?php echo get_phrase('second_test');?></th>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control" name="other_mark_<?php echo $row['mark_id'];?>"
                                   value="<?php echo $row['other_mark'];?>">
                        </td>

                        <td>
                            <input type="text" class="form-control" name="mark_test_1_<?php echo $row['mark_id'];?>"
                                   value="<?php echo $row['mark_test_1'];?>">
                        </td>
                        <td>
                            <input type="text" class="form-control" name="mark_test_2_<?php echo $row['mark_id'];?>"
                                   value="<?php echo $row['mark_test_2'];?>">
                        </td>
