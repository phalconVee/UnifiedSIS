...
class Parents extends CI_Controller
{
    ...
    function marks($param1 = '', $pin = '')
    {
        ...
        if($result_checker_settings == 1 && $pin == '') {
            redirect(base_url() . 'index.php?parents/result_checker/' . $param1, 'refresh');
        }
    ...
    function result_checker($student_id='', $param2='')
    {
        ...
        if($param2 == 'check_result'){
            ...
            if($validate->num_rows() > 0){
                ...
                redirect(base_url() . 'index.php?parents/marks/' . $student_id . '/'. $hashed_string, 'refresh');
            }
            else{
                $this->session->set_flashdata('error_message' , get_phrase('this_pin_does_not_exist'));
            }

            redirect(base_url() . 'index.php?parents/result_checker/'.$student_id, 'refresh');
        }
    ...
    function manage_profile($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'update_profile_info') {
            ...
            $validation = parent_username_validation_for_edit($data['username'], $this->session->userdata('parent_id'), 'parent');
            if ($validation == 1) {
